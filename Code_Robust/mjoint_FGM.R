...
mjoint_FGM = function(Mixeffect, data, dat, Sur1, Sur2, formSurv1, formSurv2, nMC, iter_max)
{
  #*********************Get initial value*****************************
  #****************Longitudinal first*******************
  ...
  {
    out = stepEM_FGM(theta = theta, l = l, t.1 = t.1, s.1 = s.1,
